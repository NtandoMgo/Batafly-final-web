      ...
      <div className="image-container">
        <div className="image-left">
          ...
          <div className="overlay-text">
            ...
            <p className="text2">Being in touch with the digital world is the first step in preparing 
              for the future, as it is the new frontier for most organizations and clients.
            </p>
